...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { student_id: @attendance.student_id, when: @attendance.when } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { student_id: @attendance.student_id, when: @attendance.when } }
